...
export function CommissionDetail({ commission, providerName, tripName, onMarkPaid, onUpdateTracking, onUpdateProjectionRate, onOpenTrip, onOpenProvider, recordActions }: CommissionDetailProps) {
